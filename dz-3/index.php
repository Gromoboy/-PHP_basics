...
<!--		</div>-->
    ...
    <?php
            $menu = ['ГЛАВНАЯ','НОВОСТИ'=>['Новости спорта','Новости о политике','Новости науки'],'О НАС','КОНТАКТЫ'];
            function createMenu($menuData, $submenu=false) {
                ...
                foreach ($menuData as $key => $data) {
                    ...
                    $element = $submenu ?  "<a>$data</a>" : "<div><a>$data</a></div>";
                    echo $element;
                }
            }
            createMenu($menu);
